package ch.inf.vs.scandium.connector;
...
import ch.inf.vs.scandium.RawDataChannel;
...
public abstract class ConnectorBase implements Connector {
	...
	/** The Logger. */
	private final static Logger LOGGER = ScandiumLogger.getLogger(ConnectorBase.class);
